...
contract VRFConsumer is VRFConsumerBaseV2Plus {
    ...
    // Base coordinator. For other networks,
    ...
    function checkIfRollInProgress(address player) public view returns (bool) {
        return s_results[player] == ROLL_IN_PROGRESS;
    }

    function checkIfRollCompleted(address player) public view returns (bool) {
        return s_results[player] != ROLL_IN_PROGRESS;
    }
}
